      ...
      <div className="overflow-hidden bg-white dark:bg-gray-900 lg:mx-8 lg:flex lg:w-full lg:max-w-6xl lg:rounded-xl lg:shadow-md">
        ...
        <div className="max-w-xl px-6 py-12 lg:w-1/2 lg:max-w-5xl">
          ...
          <div className="mt-6 inline-flex w-full sm:w-auto">
            <a
              href={buttonUrl}
              className="inline-flex w-full items-center justify-center rounded-lg bg-gray-800 px-6 py-2 text-sm text-white duration-300 hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80"
            >
              {buttonLabel}
            </a>
          </div>
